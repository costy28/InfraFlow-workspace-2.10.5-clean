...
export default function AuditFiscal() {
  ...
  async function load() {
    try {
      const [acceptanceResponse, saftResponse, runsResponse, validatorResponse] = await Promise.all([

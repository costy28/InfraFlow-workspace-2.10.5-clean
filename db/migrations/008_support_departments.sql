...
BEGIN
  CREATE TABLE archive.loans (
    ...
    imprumutat_de nvarchar(64) not null,
...
BEGIN
  CREATE TABLE secretariat.incoming (
    ...
    departament_destinatar nvarchar(64) null,
    responsabil_id nvarchar(64) null,
...
BEGIN
  CREATE TABLE secretariat.outgoing (
    ...
    subiect nvarchar(300) not null,
    departament_emitent nvarchar(64) null,
    intocmit_de nvarchar(64) null,
...
BEGIN
  CREATE TABLE legal.opinions (
    ...
    solicitant_id nvarchar(64) null,
    document_id int null,
...
BEGIN
  CREATE TABLE secretariat.registry (
    ...
    destinatar nvarchar(200) null,
    subiect nvarchar(300) not null,
    dept_destinatar nvarchar(64) null,

...
BEGIN
  CREATE TABLE tickets.tickets (
    ...
    dept_sursa_id nvarchar(64) null,
    dept_responsabil_id nvarchar(64) null,
    asignat_la nvarchar(64) null,
    creat_de nvarchar(64) not null,
    rezolvat_de nvarchar(64) null,
...
BEGIN
  CREATE TABLE tickets.attachments (
    ...
    fisier_nume nvarchar(200) null,
    fisier_marime int null,
    incarcat_de nvarchar(64) not null,
...
BEGIN
  CREATE TABLE tickets.escalations (
    ...
    ticket_id int not null,
    de_la_user_id nvarchar(64) null,
    catre_user_id nvarchar(64) null,
...
BEGIN
  CREATE TABLE documents.document_types (
    ...
    workflow_template_id nvarchar(64) null,
...
BEGIN
  CREATE TABLE documents.documents (
    ...
    creat_de nvarchar(64) not null,
    dept_initiatoare nvarchar(64) null,
...
BEGIN
  CREATE TABLE documents.circuit_steps (
    ...
    constraint fk_documents_circuit_steps_rol foreign key (rol_responsabil) references core.roles(id) on delete no action,
...
BEGIN
  CREATE TABLE documents.document_shares (
    ...
    document_id int not null,
    shared_with_dept nvarchar(64) null,
    shared_with_user nvarchar(64) null,
    nivel_acces nvarchar(30) not null constraint df_documents_document_shares_nivel default N'citire',
    shared_by nvarchar(64) not null,
...
BEGIN
  CREATE TABLE field.site_issues (
    ...
    raportat_de nvarchar(64) not null,
    asignat_la nvarchar(64) null,
    rezolvat_la datetime2(0) null,

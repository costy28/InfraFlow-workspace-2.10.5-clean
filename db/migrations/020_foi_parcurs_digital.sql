...
BEGIN
  ...
  IF COL_LENGTH(N'fleet.trip_logs', N'responsabil_id') IS NULL ALTER TABLE fleet.trip_logs ADD responsabil_id nvarchar(64) NULL;
  ...
  IF COL_LENGTH(N'fleet.trip_logs', N'aprobat_de') IS NULL ALTER TABLE fleet.trip_logs ADD aprobat_de nvarchar(64) NULL;

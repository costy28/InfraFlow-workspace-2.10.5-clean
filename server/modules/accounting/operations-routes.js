...
function normalizeFixedAsset(body, accounting, existing = {}) {
  ...
  return {
    ...
    category_code: String(body.category_code || existing.category_code || "2.1"),
    depreciation_method: "linear",
    fiscal_life_months: Number(body.fiscal_life_months || existing.fiscal_life_months || life),
    location: String(body.location || existing.location || ""),
    custodian: String(body.custodian || existing.custodian || ""),

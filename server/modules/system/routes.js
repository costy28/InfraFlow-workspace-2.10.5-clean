...
const { createSystemUpdateRouter } = require('./update-routes')
...
router.use(createSystemUpdateRouter({
  ROOT,
...
router.use(createSystemUsersRouter({
  readJsonBody,
  sendJson,
  roleExists,
...
router.use(createSystemDepartmentsRouter({
  readJsonBody,
  sendJson,
  throwHttp,
  id
...
router.use(createSystemSettingsRouter({
  readJsonBody,
  sendJson,
  throwHttp,
  publicSettings,

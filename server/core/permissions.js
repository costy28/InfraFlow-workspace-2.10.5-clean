const permissionGroups = {
  ...
  hr: ["hr:view", "hr:view_own", "hr:leave_own", "hr:manage", "hr:employees_manage", "hr:personal_sensitive", "hr:medical_view", "hr:timesheet", "hr:timesheet_dept", "hr:timesheets_view", "hr:timesheets_manage", "hr:timesheet_approve", "hr:timesheets_validate", "hr:leave_manage", "hr:authorizations_manage", "hr:contracts_manage", "hr:reports", "hr:reges_export", "hr:salary_view", "hr:training"],
...
const permissionLabels = {
  ...
  "echipamente:gestionar": "Administreaza catalogul si dotarile angajatilor",
  ...
  "fleet:faz_view": "Vede FAZ utilaje",
  "fleet:faz_create": "Creeaza FAZ utilaje",
  "fleet:faz_edit": "Editeaza FAZ utilaje draft",
  "fleet:faz_sign": "Semneaza FAZ utilaje",
  "fleet:faz_approve": "Aproba FAZ utilaje",
  "fleet:faz_import": "Importa FAZ din Autominder",
  ...
  "hr:personal_sensitive": "Vede date personale sensibile HR",
  "hr:medical_view": "Vede date medicale HR",
...
const DEFAULT_CUSTOM_ROLES = [
  ...
  },
  {
    ...
    permissions: [
      'dashboard:view',
      'hr:view', 'hr:manage', 'hr:employees_manage', 'hr:personal_sensitive', 'hr:medical_view',

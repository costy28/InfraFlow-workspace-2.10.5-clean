...
**Versiune curentă sursă: v2.12.385**
**Versiune în lucru: v2.12.385**
...
```
VERSIUNE CURENTĂ SURSĂ: 2.12.385
BUILD EXE EXISTENT: 2.12.210 ✅
UPDATE ZIP CURENT: 2.12.385 ✅
...
SMTP Email
  ...
  Status Inbox ERP: fundație internă + categorii + filtre + task/document din email + sursă vizibilă în Documente + trimitere email din Mesaje + CC/BCC și atașamente + răspuns/forward + drafturi + SMTP stabilizat + diagnostic prietenos + acțiuni rapide/în masă + primire IMAP manuală ✅
...
*AGENTS.md actualizat: 26 Iulie 2026 | InfraFlow sursă v2.12.385*

...
AllowNoIcons=yes
OutputDir=output
OutputBaseFilename=InfraFlow-Setup-v2.10.5
...
Source: "..\data\app-db.json"; DestDir: "{app}\data"; Flags: ignoreversion onlyifdoesntexist uninsneveruninstall
...
begin
  WizardForm.WelcomeLabel2.Caption :=
    'Acest program va instala InfraFlow ERP v2.10.5.' + #13#10#13#10 +

...
1. **Securitate fișiere /storage** — rezolvată parțial în 2.12.530–2.12.531
   ...
   - Recomandare rămasă: migrare graduală a finding-urilor medium către endpoint-uri dedicate pe entitate, cu autorizare pe dosar/document/atașament. Auditul automat pentru detectarea expunerilor este introdus în v2.12.534, linkurile directe Fleet high din `FisaVehicul.jsx` și `MyVehicle.jsx` sunt închise în v2.12.535, referințele text din Mecanizare sunt sanitizate în v2.12.536, atașamentele Tichete folosesc endpoint dedicat fără path intern expus în v2.12.537, iar Secretariat folosește upload real plus download controlat în v2.12.538.

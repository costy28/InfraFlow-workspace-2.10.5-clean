...
const endpointChecks = [
  ...
  { name: 'Comunicare /api/messaging/email/inbox drafturi', path: '/api/messaging/email/inbox?direction=draft', countKeys: ['emails'], validate: data => Array.isArray(data?.emails) && typeof data?.stats === 'object' },
